...
export default function page() {
  const privacyPolicy = {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            ...
            description:
              'To deliver our AI features, your prompts and relevant context are processed exclusively using Together.ai native models hosted on Aphura Cloud. Your data is used solely for generating AI responses to your requests. We do not use your data to train AI models.',
          },
          {
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            ...
            description:
              'Your data is stored on Aphura Cloud infrastructure with strict access controls.',
          },
          {
            text: '3.3 Important Clarification.',
            description:
              'Conversations are decrypted server-side when transmitted to Aphura Cloud APIs for processing. This encryption is not end-to-end in the cryptographic sense.',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            text: 'Deletion.',
            description:
              'You may request deletion of your account and personal data by contacting us at legal@aphura.ai. Deletion requests are processed within thirty (30) days.',
          },
          {
            text: 'Jurisdiction-Specific Rights.',
            description:
              'You may have additional rights under CCPA, GDPR, or other applicable laws. Contact us at legal@aphura.ai to exercise these rights.',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        content:
          'If you have questions about this Privacy Policy, contact us at: legal@aphura.ai, or by mail at: Aphura, 280 N Old Woodward, Birmingham, MI 48009.',
      },
    ],
    conclusion: '',
  };
  ...
  const termsOfUse = {
    title: 'Terms of Use',
    intro:
      'These Terms of Use ("Terms") govern your access to and use of the Aphura platform at aphura.ai and all related services. By using the Platform, you agree to be bound by these Terms.',
    sections: [
      {
      ...
      },
      {
        ...
        content:
          'You are responsible for maintaining the confidentiality of your account credentials and for all activities under your account. Notify us immediately at legal@aphura.ai if you suspect unauthorized access.',
      },
      {
      ...
      },
      {
        ...
        content:
          'You retain ownership of your content. You own AI-generated outputs subject to these Terms. The Platform and its underlying technology remain the exclusive property of Aphura, protected by intellectual property laws. We do not use your content to train AI models.',
      },
      {
      ...
      },
      {
        ...
        content:
          'TO THE MAXIMUM EXTENT PERMITTED BY LAW, APHURA SHALL NOT BE LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES. OUR TOTAL LIABILITY SHALL NOT EXCEED THE GREATER OF THE AMOUNT YOU PAID IN THE PRECEDING TWELVE (12) MONTHS OR ONE HUNDRED DOLLARS ($100).',
      },
      {
      ...
      },
      {
        heading: '11. Contact',
        content:
          'Questions about these Terms may be directed to: legal@aphura.ai, or by mail at: Aphura, 280 N Old Woodward, Birmingham, MI 48009.',
      },
    ],
    conclusion: '',
  };
