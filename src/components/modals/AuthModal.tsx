...
export function AuthModal() {
  ...
  const handleGoogleSignIn = () => {
    ...
    const onMessage = async (event: MessageEvent) => {
      ...
      if (event.data?.type !== 'inso-google-auth') return;
                    ...
                    <FormItem>
                      <FormControl>
                        <Input
                          ...
                          type="email"
                          placeholder="Email"
                          className="w-full border-none bg-[#e1e1e1] bg-auth-input focus-visible:ring-0 autofill:shadow-[0_0_0_1000px_#F5F5F7_inset] dark:autofill:shadow-[0_0_0_1000px_#27272a_inset]"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
          ...
          <div className="flex flex-col items-center gap-4 p-4">
            ...
            <div className="w-full space-y-4">
              <Input
                ...
                className="w-full border-none bg-[#e1e1e1] bg-auth-input text-center text-xl tracking-[0.5em] focus-visible:ring-0 autofill:shadow-[0_0_0_1000px_#F5F5F7_inset] dark:autofill:shadow-[0_0_0_1000px_#27272a_inset]"
              />
              {verifyError && (
