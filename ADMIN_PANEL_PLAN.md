# Inso Assistant Admin Panel — Implementation Plan
...
embedded** in `Inso.Assistant.Frontend`.
...
- [x] `pnpm create next-app inso-admin --typescript --tailwind --app --src-dir --import-alias "@/*"`
...
steps:
  - name: 'gcr.io/cloud-builders/docker'
    args: ['build', '-t', 'gcr.io/$PROJECT_ID/inso-admin', '.']
  - name: 'gcr.io/cloud-builders/docker'
    args: ['push', 'gcr.io/$PROJECT_ID/inso-admin']
  - name: 'gcr.io/google.com/cloudsdktool/cloud-sdk'
    args:
      ...
      - deploy
      - inso-admin
      - --image=gcr.io/$PROJECT_ID/inso-admin
      - --region=us-central1
      - --platform=managed
