      ...
      <div className="flex-1 overflow-y-auto min-h-0 px-8 py-6">
        <div className="w-full space-y-4">
          <Textarea
            ...
            className="w-full min-h-[160px] rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-zinc-900 p-4 text-base text-gray-800 placeholder-gray-400 dark:text-gray-100 dark:placeholder-gray-400 outline-none focus:outline-none focus:ring-0 focus-visible:ring-0 shadow-sm transition-all resize-none"
            disabled={isLoading}
            rows={6}
          />
