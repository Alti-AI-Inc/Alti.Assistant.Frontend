...
export default function page() {
  const privacyPolicy = {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            text: '6.3 Deletion.',
            description:
              'You may request the deletion of your account and personal data by using the account deletion feature in your settings or by contacting us at legal@alti.app. We will process deletion requests within thirty (30) days.',
          },
          {
      ...
      },
      {
        ...
        content:
          'The Platform is not intended for individuals under the age of eighteen (18). We do not knowingly collect personal information from children. If we become aware that we have collected personal information from a child under 18, we will take steps to delete that information promptly. If you believe a child has provided us with personal information, please contact us at legal@alti.app.',
      },
      {
      ...
      },
      {
        ...
        content:
          'If you have any questions, concerns, or requests regarding this Privacy Policy or our data practices, please contact us at: legal@alti.app, or by mail at: Alti, 280 N Old Woodward, Birmingham, MI 48009.',
      },
    ],
    conclusion: '',
  };
  ...
  const terms = {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          'If you have any questions about these Terms of Use, please contact us at: legal@alti.app, or by mail at: Alti, 280 N Old Woodward, Birmingham, MI 48009.',
      },
    ],
    conclusion: '',
  };
  ...
  const cookiesPolicy = {
    ...
    intro:
      'This Cookies Policy explains how Alti ("Alti," "we," "us," or "our") uses cookies and similar technologies when you use our Platform at alti.app and our mobile applications. This policy should be read in conjunction with our Privacy Policy and Terms of Use.',
    sections: [
      {
      ...
      },
      {
        ...
        content:
          'If you have any questions about our use of cookies or this Cookies Policy, please contact us at: legal@alti.app, or by mail at: Alti, 280 N Old Woodward, Birmingham, MI 48009.',
      },
    ],
    conclusion: '',
  };
