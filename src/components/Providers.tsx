...
export default function Providers({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const handleGlobalError = (event: ErrorEvent) => {
      ...
      if (isChunkLoadError) {
        console.warn(
          'Inso Search Shield: Detected chunk loading or Server Action mismatch. Performing automatic recovery refresh...',
        );
    ...
    const handleUnhandledRejection = (event: PromiseRejectionEvent) => {
      ...
      if (isChunkLoadError) {
        console.warn(
          'Inso Search Shield: Detected unhandled chunk/Server Action rejection. Performing automatic recovery refresh...',
        );
        window.location.reload();
      }
    };
