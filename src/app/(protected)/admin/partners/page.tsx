...
export default function AdminPartnersPage() {
  ...
  // Partner row password reveal states
  ...
  const partnersList: PartnerEntry[] = partners
  ...
  const handleDelete = () => {
    ...
    const newList = partnersList.filter((_, idx) => idx !== deletingIndex);
    setPartners(newList.map(item => JSON.stringify(item)).join('\n\n'));
        ...
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 flex-1 min-h-0">
          ...
          <div className="flex-1 min-h-0 flex flex-col gap-4">
            ...
            <div className="relative w-full flex-none">
              ...
              <Input
                placeholder="Search data partners"
                value={searchTerm}
