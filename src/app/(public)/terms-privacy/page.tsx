...
export default function page() {
  const privacyPolicy = {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            text: 'Deletion.',
            description:
              'You may request deletion of your account and personal data by contacting us at legal@insohq.com. Deletion requests are processed within thirty (30) days.',
          },
          {
            text: 'Jurisdiction-Specific Rights.',
            description:
              'You may have additional rights under CCPA, GDPR, or other applicable laws. Contact us at legal@insohq.com to exercise these rights.',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        content:
          'If you have questions about this Privacy Policy, contact us at: legal@insohq.com, or by mail at: Inso Chat, 280 N Old Woodward, Birmingham, MI 48009.',
      },
    ],
    conclusion: '',
  };
  ...
  const termsOfUse = {
    title: 'Terms of Use',
    intro:
      'These Terms of Use ("Terms") govern your access to and use of the Inso Chat platform at insohq.com and all related services. By using the Platform, you agree to be bound by these Terms.',
    sections: [
      {
      ...
      },
      {
        ...
        content:
          'You are responsible for maintaining the confidentiality of your account credentials and for all activities under your account. Notify us immediately at legal@insohq.com if you suspect unauthorized access.',
      },
      {
      ...
      },
      {
        ...
        content:
          'You retain ownership of your content. You own AI-generated outputs subject to these Terms. The Platform and its underlying technology remain the exclusive property of Inso Chat, protected by intellectual property laws. We do not use your content to train AI models.',
      },
      {
      ...
      },
      {
        ...
        content:
          'TO THE MAXIMUM EXTENT PERMITTED BY LAW, INSO CHAT SHALL NOT BE LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES. OUR TOTAL LIABILITY SHALL NOT EXCEED THE GREATER OF THE AMOUNT YOU PAID IN THE PRECEDING TWELVE (12) MONTHS OR ONE HUNDRED DOLLARS ($100).',
      },
      {
      ...
      },
      {
        heading: '11. Contact',
        content:
          'Questions about these Terms may be directed to: legal@insohq.com, or by mail at: Inso Chat, 280 N Old Woodward, Birmingham, MI 48009.',
      },
    ],
    conclusion: '',
  };
