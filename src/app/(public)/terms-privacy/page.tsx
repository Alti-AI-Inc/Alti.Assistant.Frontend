...
export default function page() {
  const privacyPolicy = {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          'If you have questions about this Privacy Policy, contact us at: legal@insohq.com, or by mail at: Inso AI, 280 N Old Woodward, Birmingham, MI 48009.',
      },
    ],
    conclusion: '',
  };
  ...
  const termsOfUse = {
    title: 'Terms of Use',
    intro:
      'These Terms of Use ("Terms") govern your access to and use of the Inso AI platform at insohq.com and all related services. By using the Platform, you agree to be bound by these Terms.',
    sections: [
      {
      ...
      },
      {
        heading: '11. Contact',
        content:
          'Questions about these Terms may be directed to: legal@insohq.com, or by mail at: Inso AI, 280 N Old Woodward, Birmingham, MI 48009.',
      },
    ],
    conclusion: '',
  };
