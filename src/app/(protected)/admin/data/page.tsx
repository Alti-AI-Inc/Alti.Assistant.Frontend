      ...
      <div className="flex-1 min-h-0 px-8 py-6 overflow-hidden flex flex-col">
        <div className="flex w-full flex-col gap-6 flex-1 min-h-0">
          ...
          <div className="flex-1 min-h-0 flex flex-col gap-4">
            ...
            <div
              className={`relative w-full flex-none flex items-center gap-2 bg-white dark:bg-gray-900 border border-black/10 dark:border-white/10 rounded-lg shadow-sm pr-2 transition-colors ${isDragActive ? 'ring-2 ring-blue-400 border-blue-400' : ''}`}
              onDragOver={(e) => {
                e.preventDefault();
