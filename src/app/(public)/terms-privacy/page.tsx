...
export default function page() {
  const privacyPolicy = {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          'If you have questions about this Privacy Policy, contact us at: legal@altihq.com, or by mail at: Alti AI, 280 N Old Woodward, Birmingham, MI 48009.',
      },
    ],
    conclusion: '',
  };
  ...
  const termsOfUse = {
    title: 'Terms of Use',
    intro:
      'These Terms of Use ("Terms") govern your access to and use of the Alti AI platform at altihq.com and all related services. By using the Platform, you agree to be bound by these Terms.',
    sections: [
      {
      ...
      },
      {
        ...
        content:
          'You retain ownership of your content. You own AI-generated outputs subject to these Terms. The Platform and its underlying technology remain the exclusive property of Alti AI, protected by intellectual property laws. We do not use your content to train AI models.',
      },
      {
      ...
      },
      {
        ...
        content:
          'TO THE MAXIMUM EXTENT PERMITTED BY LAW, ALTI AI SHALL NOT BE LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES. OUR TOTAL LIABILITY SHALL NOT EXCEED THE GREATER OF THE AMOUNT YOU PAID IN THE PRECEDING TWELVE (12) MONTHS OR ONE HUNDRED DOLLARS ($100).',
      },
      {
      ...
      },
      {
        heading: '11. Contact',
        content:
          'Questions about these Terms may be directed to: legal@altihq.com, or by mail at: Alti AI, 280 N Old Woodward, Birmingham, MI 48009.',
      },
    ],
    conclusion: '',
  };
