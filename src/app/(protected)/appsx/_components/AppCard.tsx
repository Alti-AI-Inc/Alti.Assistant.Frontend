...
const MCP_BLUEPRINTS: Record<string, AppBlueprint> = {
  ...
  "minio": {
    ...
    placeholders: {
      ...
      "AWS_S3_BUCKET": "my-aphura-bucket",
...
const STRATEGIC_APPS_STYLE: Record<string, { category: string; color: string; bgGlow: string; badge: string; hoverBorder: string }> = {
  ...
  tipaphura: { category: 'Expense & AP Core', color: 'border-yellow-500/40 text-yellow-600 dark:text-yellow-400 bg-yellow-50/50 dark:bg-yellow-950/20', bgGlow: 'shadow-[0_0_15px_rgba(234,179,8,0.15)]', badge: 'Global AP', hoverBorder: 'border-yellow-500/60' },
