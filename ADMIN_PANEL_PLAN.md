# Inso Search Admin Panel — Implementation Plan
...
- [x] `pnpm create next-app insosearch-admin --typescript --tailwind --app --src-dir --import-alias "@/*"`
...
steps:
  - name: 'gcr.io/cloud-builders/docker'
    args: ['build', '-t', 'gcr.io/$PROJECT_ID/insosearch-admin', '.']
  - name: 'gcr.io/cloud-builders/docker'
    args: ['push', 'gcr.io/$PROJECT_ID/insosearch-admin']
  - name: 'gcr.io/google.com/cloudsdktool/cloud-sdk'
    args:
      ...
      - deploy
      - insosearch-admin
      - --image=gcr.io/$PROJECT_ID/insosearch-admin
      - --region=us-central1
      - --platform=managed
