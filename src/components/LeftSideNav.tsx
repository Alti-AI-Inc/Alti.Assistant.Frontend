...
const LeftSideNav = ({ side = 'left' }: LeftSideNavProps) => {
  ...
  return (
    <>
      ...
      {!hideSidebar && isLoggedIn && side !== 'right' && !isAdminMode && isActionSuiteExpanded && (
        <div className="flex flex-col border-b border-black/10 dark:border-zinc-800/80 bg-[#FFFFFF] dark:bg-zinc-900 transition-colors duration-300 animate-in fade-in slide-in-from-top-1 duration-200">
          <div className="px-5 pt-2 flex items-center justify-between text-[9px] font-semibold text-zinc-400 dark:text-zinc-500 tracking-wider uppercase select-none">
