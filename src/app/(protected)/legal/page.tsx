  ...
  const privacyPolicy = {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            text: '6.3 Deletion.',
            description:
              'You may request the deletion of your account and personal data by using the account deletion feature in your settings or by contacting us at legal@insohq.com. We will process deletion requests within thirty (30) days.',
          },
          {
      ...
      },
      {
        ...
        content:
          'The Platform is not intended for individuals under the age of eighteen (18). We do not knowingly collect personal information from children. If we become aware that we have collected personal information from a child under 18, we will take steps to delete that information promptly. If you believe a child has provided us with personal information, please contact us at legal@insohq.com.',
      },
      {
