...
export default function page() {
  const privacyPolicy = {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            text: 'Deletion.',
            description:
              'You may request deletion of your account and personal data by contacting us at legal@insosearch.com. Deletion requests are processed within thirty (30) days.',
          },
          {
            text: 'Jurisdiction-Specific Rights.',
            description:
              'You may have additional rights under CCPA, GDPR, or other applicable laws. Contact us at legal@insosearch.com to exercise these rights.',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        content:
          'If you have questions about this Privacy Policy, contact us at: legal@insosearch.com, or by mail at: Aphura, 280 N Old Woodward, Birmingham, MI 48009.',
      },
    ],
    conclusion: '',
  };
  ...
  const termsOfUse = {
    title: 'Terms of Use',
    intro:
      'These Terms of Use ("Terms") govern your access to and use of the Aphura platform at insosearch.com and all related services. By using the Platform, you agree to be bound by these Terms.',
    sections: [
      {
      ...
      },
      {
        ...
        content:
          'You are responsible for maintaining the confidentiality of your account credentials and for all activities under your account. Notify us immediately at legal@insosearch.com if you suspect unauthorized access.',
      },
      {
      ...
      },
      {
        heading: '11. Contact',
        content:
          'Questions about these Terms may be directed to: legal@insosearch.com, or by mail at: Aphura, 280 N Old Woodward, Birmingham, MI 48009.',
      },
    ],
    conclusion: '',
  };
