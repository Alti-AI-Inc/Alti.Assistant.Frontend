...
export default function AdminInvoicesPage() {
  ...
  const handleDownloadPDF = async (invoice: typeof INVOICES[0]) => {
    ...
    try {
      ...
      // Header Inso Assistant Branding
      ...
      doc.setFont('helvetica', 'normal');
      doc.text('Inso Assistant Inc.', 120, 66);
      ...
      doc.setFont('helvetica', 'normal');
      doc.text(`Inso Assistant Pro Subscription - ${invoice.month}`, 25, 102);
      doc.text('1', 120, 102);
      ...
      doc.text(
        'Thank you for partnering with Inso Assistant! If you have any billing queries, reach out at support@insohq.com',
        20,
        150
      );
