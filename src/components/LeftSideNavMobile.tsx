          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className={cn(
                  "relative size-10 flex items-center justify-center rounded-xl border border-[#0000ff] transition-all duration-300 cursor-pointer text-white",
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
                      ...
                      className={cn(
                        "relative size-10 flex items-center justify-center rounded-xl border border-[#0000ff] transition-all duration-300 cursor-pointer text-sm font-semibold text-white",
                        isSelected
                          ? "bg-[#0000ff]/15 shadow-[0_0_20px_rgba(0,0,255,0.55)]"
                          : "bg-[#0000ff]/10 hover:rounded-2xl hover:bg-[#0000ff]/20 hover:shadow-[0_0_15px_rgba(0,0,255,0.35)]",
